...
const ShowFactura = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {compra ? (
        <div>
          <h1 className="text-3xl font-bold mb-4 text-blue-600">Detalles de la compra con ID: {id}</h1>
          ...
          <h2 className="text-2xl font-bold mt-6 mb-2 text-blue-600">Productos:</h2>
            ...
            <tbody>
              {compra.productos.map((producto, index) => (
                <tr key={index}>
                  ...
                  <td className="border border-gray-200 px-4 py-2">{producto.costo}</td>
                </tr>
              ))}
            </tbody>
          </table>
